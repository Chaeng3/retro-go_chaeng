...
- **阅读操作**：菜单键、设置键与模拟器相同（存档槽 / 系统选项）
- **翻页**：上/A 上一页，下/B 下一页；左/右按约 5% 进度跳转；选择/开始调节字号
- **存档**：中文书名路径兼容（rename 失败时回退直接写入）
- **界面字库**：FusionPixel 扩至完整 GB2312，修复中文书名缺字
- **翻译**：补充存档槽预览、超频等中文文案

更多历史见 [CHANGELOG.md](CHANGELOG.md)
...
## 📌 硬件开源地址（已加入“星火计划2026”）<img width="128" height="34.625" alt="星火计划-透底黑" src="https://github.com/user-attachments/assets/2364c178-28e4-4ff4-a0f0-2123fbc0edbf" />
